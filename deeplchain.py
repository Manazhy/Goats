...
def banner():
    banner = r"""
   _____ __________  ________  ______   ______  __   
  / ___// ____/ __ \/  _/ __ \/_  __/  / __ ) \/ /   
  \__ \/ /   / /_/ // // /_/ / / /    / __  |\  /    
 ___/ / /___/ _, _// // ____/ / /    / /_/ / / /     
/____/\____/_/ |_/___/_/     /_/    /_____/ /_/      
                                                     """ 
...
╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝  ╚═════╝  ╚══╝╚══╝ 
    ...
    print(hju + f"𝗦𝗖𝗥𝗜𝗣𝗧 𝗕𝗬 𝗦𝗛𝗔𝗗𝗢𝗪")
    print(mrh + f" FREE TO USE = CRYPTO CRACKERS")
    print(mrh + f" Admins '{hju}APK SHADOW {mrh}' Criminal")
    log_line()
